            ...
            if (isset($_POST['Cat_id']) &&
                ...
                if ($sub_cat=='/'){
                    ...
                    $select_foods = mysqli_query($functions->connection(),
                        "SELECT * FROM foods where cat_id = '$cat_id' AND sub_cat_id = '/' Limit 20 offset $offset");
                    ...
                    $select_foods1 = mysqli_query($functions->connection(),
                        "SELECT * FROM foods where cat_id = '$cat_id' AND sub_cat_id = '$sub_cat' Limit 20 offset $offset");
